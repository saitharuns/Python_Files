...
age_e= Entry(window,font=('Impact',20),justify='center',fg='navyblue',bg='white',width=20)
age_e.grid(column=1,row=1,padx=2,pady=2)
dob_e= Entry(window,font=('Impact',20),justify='center',fg='navyblue',bg='white',width=20)
dob_e.grid(column=1,row=2,padx=2,pady=2)
